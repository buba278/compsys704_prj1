...
public class FillerVizWorker extends Worker {
      ...
      public void setSignal(boolean status) {
              ...
              case "fillFaultBigE":    FillerState.FAULT = status; break;
              case "fillerBackupBigE": FillerState.BACKUP_ACTIVE = status; break;
      ...
      static final List<String> signames = Arrays.asList("valve1OpenE", "valve2OpenE", "fillDoneE", "fillFaultE", "fillerBackupE",
              "fillFaultBigE", "fillerBackupBigE", "fillLevelE", "totalVolumeMlE");
