...
public class Plant extends ClockDomain{
  ...
  public void thread2929(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest2936 = 0;
        if(ends[8]>=biggest2936){
          biggest2936=ends[8];
        }
        if(ends[9]>=biggest2936){
          biggest2936=ends[9];
        }
        if(ends[10]>=biggest2936){
          biggest2936=ends[10];
        }
        if(ends[11]>=biggest2936){
          biggest2936=ends[11];
        }
        if(ends[12]>=biggest2936){
          biggest2936=ends[12];
        }
        if(ends[13]>=biggest2936){
          biggest2936=ends[13];
        }
        if(biggest2936 == 1){
          active[7]=1;
  ...
  public void thread2915(int [] tdone, int [] ends){
    ...
    if(ends[10]>=biggest2922){
      biggest2922=ends[10];
    }
    if(ends[11]>=biggest2922){
      biggest2922=ends[11];
    }
    if(ends[12]>=biggest2922){
      biggest2922=ends[12];
    }
    if(ends[13]>=biggest2922){
      biggest2922=ends[13];
    }
    if(biggest2922 == 1){
      active[7]=1;
    ...
    RUN: while(true){
      switch(S2908){
        ...
        case 1 : 
          ...
          int biggest2923 = 0;
          if(ends[2]>=biggest2923){
            biggest2923=ends[2];
          }
          if(ends[3]>=biggest2923){
            biggest2923=ends[3];
          }
          if(ends[4]>=biggest2923){
            biggest2923=ends[4];
          }
        ...
        case 2 : 
          ...
          int biggest2937 = 0;
          if(ends[2]>=biggest2937){
            biggest2937=ends[2];
          }
          if(ends[3]>=biggest2937){
            biggest2937=ends[3];
          }
          if(ends[4]>=biggest2937){
            biggest2937=ends[4];
          }
          if(ends[5]>=biggest2937){
            biggest2937=ends[5];
          }
          if(ends[6]>=biggest2937){
            biggest2937=ends[6];
          }
          if(ends[7]>=biggest2937){
            biggest2937=ends[7];
          }
          if(biggest2937 == 1){
            active[1]=1;
