...
public class Plant extends ClockDomain{
  ...
  public void thread2857(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        if(ends[10]>=biggest2864){
          biggest2864=ends[10];
        }
        if(ends[11]>=biggest2864){
          biggest2864=ends[11];
        }
        if(ends[12]>=biggest2864){
          biggest2864=ends[12];
        }
        if(ends[13]>=biggest2864){
          biggest2864=ends[13];
        }
        if(biggest2864 == 1){
          active[7]=1;
  ...
  public void thread2843(int [] tdone, int [] ends){
    ...
    int biggest2850 = 0;
    if(ends[8]>=biggest2850){
      biggest2850=ends[8];
    }
    if(ends[9]>=biggest2850){
      biggest2850=ends[9];
    }
    if(ends[10]>=biggest2850){
      biggest2850=ends[10];
    }
    if(ends[11]>=biggest2850){
      biggest2850=ends[11];
    }
    if(ends[12]>=biggest2850){
      biggest2850=ends[12];
    }
    if(ends[13]>=biggest2850){
      biggest2850=ends[13];
    }
    if(biggest2850 == 1){
      active[7]=1;
    ...
    RUN: while(true){
      switch(S2836){
        ...
        case 2 : 
          ...
          int biggest2865 = 0;
          if(ends[2]>=biggest2865){
            biggest2865=ends[2];
          }
          if(ends[3]>=biggest2865){
            biggest2865=ends[3];
          }
          if(ends[4]>=biggest2865){
            biggest2865=ends[4];
          }
          if(ends[5]>=biggest2865){
            biggest2865=ends[5];
          }
          if(ends[6]>=biggest2865){
            biggest2865=ends[6];
          }
          if(ends[7]>=biggest2865){
            biggest2865=ends[7];
          }
          if(biggest2865 == 1){
            active[1]=1;
