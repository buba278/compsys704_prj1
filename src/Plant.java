...
public class Plant extends ClockDomain{
  ...
  public void thread3140(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest3147 = 0;
        if(ends[8]>=biggest3147){
          biggest3147=ends[8];
        }
        if(ends[9]>=biggest3147){
          biggest3147=ends[9];
        }
  ...
  public void thread3126(int [] tdone, int [] ends){
    ...
    int biggest3133 = 0;
    if(ends[8]>=biggest3133){
      biggest3133=ends[8];
    }
    if(ends[9]>=biggest3133){
      biggest3133=ends[9];
    }
    if(ends[10]>=biggest3133){
      biggest3133=ends[10];
    }
    if(ends[11]>=biggest3133){
      biggest3133=ends[11];
    }
    if(ends[12]>=biggest3133){
      biggest3133=ends[12];
    }
    ...
    RUN: while(true){
      switch(S3119){
        ...
        case 1 : 
          ...
          int biggest3134 = 0;
          if(ends[2]>=biggest3134){
            biggest3134=ends[2];
          }
          if(ends[3]>=biggest3134){
            biggest3134=ends[3];
          }
          if(ends[4]>=biggest3134){
            biggest3134=ends[4];
          }
          if(ends[5]>=biggest3134){
            biggest3134=ends[5];
          }
          if(ends[6]>=biggest3134){
            biggest3134=ends[6];
          }
          if(ends[7]>=biggest3134){
            biggest3134=ends[7];
          }
          if(biggest3134 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          int biggest3148 = 0;
          if(ends[2]>=biggest3148){
            biggest3148=ends[2];
          }
          if(ends[3]>=biggest3148){
            biggest3148=ends[3];
          }
          if(ends[4]>=biggest3148){
            biggest3148=ends[4];
          }
          if(ends[5]>=biggest3148){
            biggest3148=ends[5];
          }
          if(ends[6]>=biggest3148){
            biggest3148=ends[6];
          }
          if(ends[7]>=biggest3148){
            biggest3148=ends[7];
          }
          if(biggest3148 == 1){
            active[1]=1;
