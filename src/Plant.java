...
public class Plant extends ClockDomain{
  ...
  public void thread3143(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest3150 = 0;
        if(ends[8]>=biggest3150){
          biggest3150=ends[8];
        }
        if(ends[9]>=biggest3150){
          biggest3150=ends[9];
        }
        if(ends[10]>=biggest3150){
          biggest3150=ends[10];
        }
        if(ends[11]>=biggest3150){
          biggest3150=ends[11];
        }
        if(ends[12]>=biggest3150){
          biggest3150=ends[12];
        }
        if(ends[13]>=biggest3150){
          biggest3150=ends[13];
        }
        if(biggest3150 == 1){
          active[7]=1;
  ...
  public void thread3129(int [] tdone, int [] ends){
    ...
    int biggest3136 = 0;
    if(ends[8]>=biggest3136){
      biggest3136=ends[8];
    }
    if(ends[9]>=biggest3136){
      biggest3136=ends[9];
    }
    if(ends[10]>=biggest3136){
      biggest3136=ends[10];
    }
    if(ends[11]>=biggest3136){
      biggest3136=ends[11];
    }
    if(ends[12]>=biggest3136){
      biggest3136=ends[12];
    }
    if(ends[13]>=biggest3136){
      biggest3136=ends[13];
    }
    if(biggest3136 == 1){
      active[7]=1;
    ...
    RUN: while(true){
      switch(S3122){
        ...
        case 1 : 
          ...
          int biggest3137 = 0;
          if(ends[2]>=biggest3137){
            biggest3137=ends[2];
          }
          if(ends[3]>=biggest3137){
            biggest3137=ends[3];
          }
          if(ends[4]>=biggest3137){
            biggest3137=ends[4];
          }
          if(ends[5]>=biggest3137){
            biggest3137=ends[5];
          }
        ...
        case 2 : 
          ...
          if(ends[5]>=biggest3151){
            biggest3151=ends[5];
          }
          if(ends[6]>=biggest3151){
            biggest3151=ends[6];
          }
          if(ends[7]>=biggest3151){
            biggest3151=ends[7];
          }
          if(biggest3151 == 1){
            active[1]=1;
