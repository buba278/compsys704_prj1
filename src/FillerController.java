...
public class FillerController extends ClockDomain{
  ...
  private int aTarget_thread_2;//sysj\fillerController.sysj line: 17, column: 4
  private int bTarget_thread_2;//sysj\fillerController.sysj line: 18, column: 4
  private int S1446 = 1;
  private int S1433 = 1;
  private int S1373 = 1;
  private int S1444 = 1;
  ...
  public void thread1452(int [] tdone, int [] ends){
      ...
      case 1 : 
        if(fillDone.getprestatus()){//sysj\fillerController.sysj line: 41, column: 14
          fillDoneE.setPresent();//sysj\fillerController.sysj line: 42, column: 6
          currsigs.addElement(fillDoneE);
          fillDoneCoordE.setPresent();//sysj\fillerController.sysj line: 43, column: 6
  ...
  public void thread1451(int [] tdone, int [] ends){
      ...
      case 1 : 
        switch(S1373){
          case 0 : 
            if(bottleAtPos2.getprestatus()){//sysj\fillerController.sysj line: 15, column: 11
              aTarget_thread_2 = ((Integer)(targetVolumeMl.getpreval() == null ? null : ((Integer)targetVolumeMl.getpreval())) * (Integer)(liquidARatio.getpreval() == null ? null : ((Integer)liquidARatio.getpreval())) / 100);//sysj\fillerController.sysj line: 17, column: 4
              bTarget_thread_2 = (Integer)(targetVolumeMl.getpreval() == null ? null : ((Integer)targetVolumeMl.getpreval()));//sysj\fillerController.sysj line: 18, column: 4
              System.out.printf("phase 1 start: aTarget=%d bTarget=%d%n", aTarget_thread_2, bTarget_thread_2);//sysj\fillerController.sysj line: 20, column: 4
              doseTargetMl.setPresent();//sysj\fillerController.sysj line: 21, column: 4
              currsigs.addElement(doseTargetMl);
              doseTargetMl.setValue(aTarget_thread_2);//sysj\fillerController.sysj line: 21, column: 4
              S1373=1;
              valve1Open.setPresent();//sysj\fillerController.sysj line: 23, column: 5
          ...
          case 1 : 
            if(levelAtTarget.getprestatus()){//sysj\fillerController.sysj line: 22, column: 11
              System.out.printf("phase 1 done, dosing to %d%n", bTarget_thread_2);//sysj\fillerController.sysj line: 25, column: 4
              doseTargetMl.setPresent();//sysj\fillerController.sysj line: 26, column: 4
              currsigs.addElement(doseTargetMl);
              doseTargetMl.setValue(bTarget_thread_2);//sysj\fillerController.sysj line: 26, column: 4
              S1373=2;
              valve2Open.setPresent();//sysj\fillerController.sysj line: 28, column: 5
          ...
          case 2 : 
            if(levelAtTarget.getprestatus()){//sysj\fillerController.sysj line: 27, column: 11
              System.out.printf("phase 2 done%n");//sysj\fillerController.sysj line: 30, column: 4
              fillDone.setPresent();//sysj\fillerController.sysj line: 32, column: 4
          ...
          case 3 : 
            if(!bottleAtPos2.getprestatus()){//sysj\fillerController.sysj line: 33, column: 11
              fillReady.setPresent();//sysj\fillerController.sysj line: 34, column: 4
